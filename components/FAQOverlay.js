   ...
   return (
      <div className={styles.faqOverlayContainer}>
         <div className={styles.faqContainer}>
            ...
            <p>Most of the images on this site come from Twitter (@weirddalle), Reddit (r/weirddalle), or submissions. Although DALL-E still has a waitlist, you can use a <a target="_blank" href="https://huggingface.co/spaces/dalle-mini/dalle-mini">mini version</a> thanks to HuggingFace.</p>
